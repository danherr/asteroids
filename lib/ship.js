(function () {
    ...
    var Ship = Asteroids.Ship = function (pos, game, options) {
        options = options || {};
        ...
        this.rDamping = options.rDamping || 0;
        this.rotation = 0;
        this.Enginesfiring = 0;
        this.heading = [0 , 1];
        this.gunTimeout = 5;
        this.equipment = {
            projectile: options.projectile || ShipParams.projectiles[0],
            offsets: options.offsets || ShipParams.offsets.start,
            gunTimeout: 10,
        }
    ...
    Ship.RADIUS = 12;
    Ship.COLOR = '#bbbbbb';
    Ship.IMPULSE_SENSITIVITY = 0.45;    

    AltShip.TURNING_SENSITIVITY = 0.15;

(function () {
    ...
    Game.prototype.resetGame = function (setup) {
        this.constructor.call(this, this.width, this.height);
    ...
    Game.prototype.addNewThings = function () {
        if (Math.random() > (1 - (this.difficulty / 1200))) {
            this.addAsteroid(
                new Asteroids.Asteroid(
                    Asteroids.Game.randomPos(this.width, this.height),
                    this,
        ...
        } else if (Math.random() > (1 - (this.difficulty / 1000))) {
            this.addAsteroid(
                new Asteroids.Asteroid(
                    Asteroids.Game.randomPos(this.width, this.height),
                    this,
        ...
        } else if (Math.random() > (1 - (this.difficulty / 800))) {
            this.addAsteroid(
                new Asteroids.Asteroid(
                    Asteroids.Game.randomPos(this.width, this.height),
                    this,

(function () {
    ...
    Menu.prototype.reDrawMenu = function () {
        ...
        this.menuData.forEach( function (menuItem, idx) {
            
            var htmlString = this.menuItemHTML(menuItem, idx);
    ...
    Menu.prototype.menuItemHTML = function (menuItem, idx) {
       var htmlText =  "<div id=\""
            + menuItem.DomId
            + "\" class=\"menu-item "
            + (idx == this.selectedIdx ? "selected" : "")
            + "\" > "
